...
namespace DigitalCurling{
    namespace Tester{
        ...
        int solverTestThread(int threadId, fpn_t *scoreSum, uint64 *timeSum,
            ...
            for (int s = 0; s < NSamples; ++s){
                ...
                uint64 time[NSolvers] = { 0 };
                uint64 trials[NSolvers] = { 0 };
        ...
        int testSolver(int NThreads){
            ...
            uint64 timeSum[NSolvers] = { 0 };

            fpn_t scoreThreadSum[NThreads][NSolvers] = { 0 };
            uint64 timeThreadSum[NThreads][NSolvers] = { 0 };
