...
namespace DigitalCurling{
    namespace b2dSimulator{
        ...
        b2Body* createBody(fpn_t x, fpn_t y, b2World *const world){
            ...
            constexpr uint32 STONEINFO_CATEGORYBITS = 3;
            constexpr uint32 STONEINFO_MASKBITS = 3;
        ...
        int simulateb2d(board_t *const pbd, uint32 stNum, const mst_t& org, const fpn_t step){
        ...
        int simulate(board_t *const pbd, uint32 stNum, const move_t& mv){
            // シミュレーション開始座標と速度
