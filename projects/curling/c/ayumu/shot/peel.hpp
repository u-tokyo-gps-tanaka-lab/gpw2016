...
namespace DigitalCurling{
    ...
    struct Peel : public ShotGenerator{
        ...
        static double estimate(const board_t& bd, uint32 stNum, const vmove_t& vmv){
            // アイデア...ハウスの向こう側の境界線との距離が小さい方が成功しやすい
            const uint32 obj = vmv.getNum0();
        ...
        static double evaluate(const board0_t& pre, const board1_t& post, uint32 stNum, const vmove_t& vmv, const ContactTree& ct = 0){
