...
public:
    ...
    this_type_t operator~()const noexcept{ return this_type_t(~dat_); }
    //this_type_t operator|(this_type_t rhs)const{ return this_type_t(*this) &= rhs; }
    //this_type_t operator&(this_type_t rhs)const{ return this_type_t(*this) &= rhs; }
    //this_type_t operator^(this_type_t rhs)const{ return this_type_t(*this) &= rhs; }
...
using BitSet8 = BitSetInRegister<uint8>;
using BitSet16 = BitSetInRegister<uint16>;
using BitSet32 = BitSetInRegister<uint32>;
using BitSet64 = BitSetInRegister<uint64>;
