...
constexpr static uint32 XYtoR2(uint32 x, uint32 y)noexcept{
    return x * x + y * y;
}

constexpr static uint32 XYtoR2(int32 x, int32 y)noexcept{
    return x * x + y * y;
}

constexpr static uint32 XYtoR2(uint64 x, uint64 y)noexcept{
    return x * x + y * y;
}

constexpr static uint32 XYtoR2(int64 x, int64 y)noexcept{
    return x * x + y * y;
}
